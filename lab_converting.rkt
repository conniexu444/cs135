...
(define (convert10 number base)
  (reverse(convert-help number base)))

(define(convert-help number base)
  (if (equal? number 0)
      '()
      (cons(modulo number base)(convert-help(quotient number base)base))))
...
(define (base10 oldbase numlist)
 (base10-help oldbase (reverse numlist)1))
(define (base10-help oldBase numberList cur)
  (if (null? numberList)
      0
      (+ (* (car numberList) cur)(base10-help oldBase(cdr numberList)(* cur oldBase)))))
